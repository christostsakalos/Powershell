...
{ 
    ...
    # Subject Setting 
    $subject="Your Company account password will expire $messageDays" 
    # Email Body Set Here, Note You can use HTML, including Images. 
    $body =" 
    <font face=""verdana""> 
    Dear $name, 
    <p> Your Company account Password will expire $messageDays<br> 
    <p> To change your password on a PC press CTRL ALT Delete and choose Change Password, if you are offsite please log into the Company VPN first. <br> 
    <p> If you do not have access to a PC you can change your password via Web Mail. <br> 
    Login to <a href=""https://Owa.server.com"">Web Mail</a> click on Options, then Change Password. 
    <p> If you recieve your company e-mails on any mobile device (apart from Blackberrys) you MUST also update the password on them! 
    <p>Thanks, <br>  
    </P> 
    IT Support 
    <a href=""mailto:helpdesk.com""?Subject=Password Expiry Assistance"">mail.company.com</a> | 074......
    </font>" 
