...
$From = "administrator@company.co.uk"
...
If you are not able to change the password on your PC or Laptop, you can always visit https://owa.exhcange.com and 
...
<p>IT Department<br>
Company<br>
<a href="mailto:SpiceWorks@company.co.uk">SpiceWorks@comapny.co.uk</a></p><br>
"@
